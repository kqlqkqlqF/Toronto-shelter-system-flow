...
months <- c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jly", "Aug", "Sep", "Oct", "Nov", "Dec")
age <- c("num_under16", "num_age16_24")
 
# Create the bar chart
ggplot(cleaned_graph_data, aes(x = months, y = age)) +        # Create barchart with ggplot2
